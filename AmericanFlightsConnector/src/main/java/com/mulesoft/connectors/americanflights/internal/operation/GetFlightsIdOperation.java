...
import com.mulesoft.connectors.americanflights.internal.metadata.GetFlightsIdOutputMetadataResolver;
...
public class GetFlightsIdOperation extends BaseRestOperation {
  ...
  /**
   * Retrieve Flight details of given flight id
   *
   * <p>This operation makes an HTTP GET request to the /flights/{ID} endpoint
   *
  ...
  @Summary("Retrieve Flight details of given flight id")
  @MediaType("application/json")
  @OutputResolver(output = GetFlightsIdOutputMetadataResolver.class)
  public void getFlightsId(
